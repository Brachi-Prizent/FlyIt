...
import { getCompany, updateFlight,getFlights } from "../../utils/page1";
...
export const UpdateFlight = () => {
    ...
    return <>UpdateFlight
        ...
        <div className='App'>
            ...
            <div className="a"><TextField label="price" variant="outlined" color="success" value={Flight?.timeFlight} onChange={(e) => setFlight({ ...Flight, dateFltimeFlightight: e.target.value })} /></div>
            <div className="a"><TextField label="nameCompany" variant="outlined" color="success" value={Flight?.price} onChange={(e) => setFlight({ ...Flight, price: e.target.value })} /></div>
